...
[Slack in the #safe-queue channel](https://callforcode.org/slack). Minor issues can simply be addressed by sending by a pull request.
...
reported by contacting the project team on [Slack in the #safe-queue channel](https://callforcode.org/slack).
