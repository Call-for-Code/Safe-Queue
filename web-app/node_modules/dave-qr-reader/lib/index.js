  ...
  _createClass(Reader, [{
    ...
    value: function initiate() {
      ...
      if(window.navigator.appVersion.indexOf('Android') !== -1) {
      	 vConstraintsPromise = getDeviceId(facingMode).then(function (deviceId) {
	        return Object.assign({}, { deviceId: deviceId }, props.constraints);
	      });
      }
      else {
      	  vConstraintsPromise = supported.facingMode || isFirefox ? Promise.resolve(props.constraints || constraints) : getDeviceId(facingMode).then(function (deviceId) {
      	  	return Object.assign({}, { deviceId: deviceId }, props.constraints);
	      });
      }
